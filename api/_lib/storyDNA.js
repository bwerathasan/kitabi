...
export const STORY_STRUCTURES = [
  {
    id: 'A',
    name: 'The Mission',
    description: 'A clear goal is established early. Obstacles escalate. A helper appears mid-journey. The climax requires everything the child has learned.',
    flow: [
      'pages 1-2: World setup and inciting incident — the mission is revealed',
      'pages 3-4: Mission accepted, journey begins, first challenge encountered',
      'pages 5-6: Serious obstacle — first approach completely fails',
      'pages 7-8: Helper appears, new understanding forms, strategy shifts',
      'pages 9-10: The personal cost becomes real — stakes deepen',
      'pages 11-13: Climax — all skills and courage tested simultaneously',
      'pages 14-15: Resolution and its immediate aftermath',
      'page 16: Quiet reflective ending — what the mission permanently changed',
    ],
  },
  {
    id: 'B',
    ...
    flow: [
      ...
      'pages 3-4: Investigation begins, first strange clue found',
      'pages 5-6: Following the clue deeper — the world grows stranger',
      'pages 7-8: False trail — the apparent answer is wrong and the child knows it',
      'pages 9-10: Deeper layer revealed — the mystery is bigger than it appeared',
      'pages 11-12: The real answer begins to surface from an unexpected direction',
      'pages 13-14: Revelation — everything the child saw before means something different now',
      'pages 15-16: Resolution with entirely new understanding',
    ],
  },
  {
    id: 'C',
    ...
    flow: [
      'pages 1-2: The problem emerges fully formed — stakes established immediately',
      'pages 3-4: First attempt — bold and confident and completely insufficient',
      'pages 5-6: What that failure taught — a crucial insight about the real problem',
      'pages 7-8: Second attempt — smarter but still missing something fundamental',
      'pages 9-10: Both failures together crystallize into real understanding',
      'pages 11-13: Third attempt — built entirely from what failure taught',
      'pages 14-15: Success and its unexpected shape — not what was imagined',
      'page 16: The permanent growth that came from having to fail first',
    ],
  },
  {
    id: 'D',
    ...
    flow: [
      'pages 1-2: Ordinary world — something feels incomplete in a way the child cannot name',
      'pages 3-4: The call arrives — inner resistance is real and understandable',
      'pages 5-6: Journey begins — the external world immediately reflects the inner state',
      'pages 7-8: The real fear or wound surfaces — the child faces it directly',
      'pages 9-10: The inner obstacle demands to be confronted, not avoided',
      'pages 11-12: The transformation moment — something releases that was held too long',
      'pages 13-14: External resolution flows naturally from the internal change',
      'pages 15-16: Return — the same world looks entirely different, correctly',
    ],
  },
  {
    id: 'E',
    ...
    flow: [
      'pages 1-3: Moving without clear purpose — pure curiosity driving everything',
      'pages 4-5: First unexpected encounter plants a seed of meaning',
      'pages 6-7: Second encounter — a pattern begins to be visible',
      'pages 8-9: Third encounter — the pattern is unmistakable now',
      'pages 10-11: The child begins to understand what they are really doing here',
      'pages 12-13: Unexpected truth arrives from an impossible direction',
      'pages 14-15: Full meaning understood — the pattern revealed completely',
      'page 16: Integration — how this shapes who the child will be from now on',
    ],
  },
]
